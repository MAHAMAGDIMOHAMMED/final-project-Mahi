        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-2 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-0 px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mr-auto py-0">
                    <a href="index.php" class="nav-item nav-link active"a href ='./single.php'>Home</a>
                    <a href="single.php" class="nav-item nav-link" a href ='./single.php'>Category</a>
                ...
                <div class="owl-carousel main-carousel position-relative">
                    <div class="position-relative overflow-hidden" style="height: 500px;">
                        ...
                        <div class="overlay">
                            ...
                            <a class="h2 m-0 text-white text-uppercase font-weight-bold" href='./single.php'>Lorem ipsum dolor sit amet elit. Proin vitae porta diam...</a>
                        </div>
                    </div>
                    <div class="position-relative overflow-hidden" style="height: 500px;">
                    ...
                    <div class="col-md-6 px-0">
                        <div class="position-relative overflow-hidden" style="height: 250px;">
                            ...
                            <div class="overlay">
                                ...
                                <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" href='./single.php'>Lorem ipsum dolor sit amet elit...</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 px-0">
            ...
            <div class="owl-carousel news-carousel carousel-item-4 position-relative">
                <div class="position-relative overflow-hidden" style="height: 300px;">
                    ...
                    <div class="overlay">
                        ...
                        <a class="h6 m-0 text-white text-uppercase font-weight-semi-bold" a href='./single.php'>Lorem ipsum dolor sit amet elit...</a>
                    </div>
                </div>
                <div class="position-relative overflow-hidden" style="height: 300px;">
        ...
        <div class="container">
            <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                ...
                                <div class="bg-white border border-top-0 p-4">
                                    ...
                                    <a class="h4 d-block mb-3 text-secondary text-uppercase font-weight-bold"  a href='./single.php'>Lorem ipsum dolor sit amet elit...</a>
                        ...
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                ...
                                <div class="bg-white border border-top-0 p-4">
                                    ...
                                    <a class="h4 d-block mb-0 text-secondary text-uppercase font-weight-bold"  a href='./single.php'>Lorem ipsum dolor sit amet elit...</a>
                                </div>
                                <div class="d-flex justify-content-between bg-white border border-top-0 p-4">
                                    <div class="d-flex align-items-center">
                                        <img class="rounded-circle mr-2" src="img/user.jpg" width="25" height="25" alt="">
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                                ...
                                <div class="w-100 h-100 px-3 d-flex flex-column justify-content-center border border-left-0">
                                    <div class="mb-2">
                                        <a class="badge badge-primary text-uppercase font-weight-semi-bold p-1 mr-2"  a href='./single.php'>Business</a>
                                        <a class="text-body" href=""><small>Jan 01, 2045</small></a>
                                    </div>
                                    <a class="h6 m-0 text-secondary text-uppercase font-weight-bold" a href='./single.php'>Lorem ipsum dolor sit amet elit...</a>
                                </div>
                            </div>
                            <div class="d-flex align-items-center bg-white mb-3" style="height: 110px;">
                ...
                <div class="col-lg-4">
                    ...
                    //  echo "<a href='./single.php?id={$category['id']}' data-filter='{$catname}'>{$catname}</a>";
                    //       }
                         ?>
                            
                     <form action= "<?php '_PHP_SELF'?>" method="post">
                     <a href="single.php" class="btn btn-sm btn-secondary m-1" $catname= $category>Health</a>
                     <a href="single.php" class="btn btn-sm btn-secondary m-1" $catname= $category>science</a>
                     <a href="single.php" class="btn btn-sm btn-secondary m-1" $catname= $category>Corporate</a>
                     <a href="single.php" class="btn btn-sm btn-secondary m-1" $catname= $category>Politics</a>
                     <a href="single.php" class="btn btn-sm btn-secondary m-1" $catname= $category>Business</a>
                     <a href="single.php" class="btn btn-sm btn-secondary m-1" $catname= $category>Education</a>
