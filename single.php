            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-3">
                     ...
                     <a href="category.php" class="btn btn-sm btn-secondary m-1" $catname= $category>Health</a>
                     <a href="category.php" class="btn btn-sm btn-secondary m-1" $catname= $category>science</a>
                     <a href="category.php" class="btn btn-sm btn-secondary m-1" $catname= $category>Corporate</a>
                     <a href="category.php" class="btn btn-sm btn-secondary m-1" $catname= $category>Politics</a>
                     <a href="category.php" class="btn btn-sm btn-secondary m-1" $catname= $category>Business</a>
                     <a href="category.php" class="btn btn-sm btn-secondary m-1" $catname= $category>Education</a>
