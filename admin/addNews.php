...
$photo_type = $photo['type'];
  ...
  if (!empty($news_date)&& !empty ($title)&& !empty ($content) && !empty($author) && !empty($category)
 && !empty($photo) && $photo_type == 'image/jpeg' || $photo_type == 'image/png' || $photo_type == 'image/gif') 
  {
   ...
   $query = "INSERT Into news (dat,title,content,author,category,photo_name, photo_path)
   VALUES('$news_date','$title','$content','$author','$category','$photo_name', '$photo_path')";
...
// 	if (!empty($photo) && $photo_type == 'image/jpeg' || $photo_type == 'image/png' || $photo_type == 'image/gif') {
...
// 		$sql = "INSERT INTO news (photo_name, photo_path) 
								...
								<div class="x_content">
									...
									<div class="item form-group">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="file" id="image"  required="required" class="form-control"name="img">
											</div>
										</div>
