...
if (!empty($full_name)&& !empty ($name)&& !empty ($email) && !empty($pw))
{

$query = "INSERT Into users(full_name,user_name,email,pw)
VALUES('$full_name','$name','$email','$pw')";
								...
								<div class="x_content">
									...
									<form action="<?php echo $_SERVER['PHP_SELF']?> "method="post">   
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="password" id="password" name="pw" required="required" class="form-control">
											</div>
										</div>
