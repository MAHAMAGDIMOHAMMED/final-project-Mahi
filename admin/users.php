...
//     if (!empty($date)&& !empty ($nam)&& !empty ($username) && !empty($email)&& !empty($edit)) 
//     {
  
  
//      $query = "INSERT Into  users_list (regestration_date,nam,username,email,edit)
//      VALUES('$date','$nam','$username','$email','$edit')";
    ...
    <div class="container body">
      <div class="main_container">
                      ...
                      <tbody>
                       ...
                       echo "
                        <tr>
                         ...
                         <td>
                          <a href='./edituser.php.?id={$k['id']}'>Edit </a> 
                           </td>
                          <td>
                          <a href='./d.php.?id={$k['id']}'>Delete </a> 
                           </td>
                        </tr>";
                       }
        ...
        <footer>
          ...
          <div class="clearfix"  name="update"></div>
        </footer>
        <!-- /footer content -->
      </div>
    </div>
